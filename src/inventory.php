...
<head>
	<title>Inventory | Toy Story</title>
...
<body>
	...
	<div class="content">
		<section class="container">
			...
			if ($results) {
				$products_item = '<table border="1" bordercolor="white" style="color:white; background-color: #444"><th>ID</th><th>Product Code</th><th>Fandom</th><th>Category</th><th>Product Name</th><th>Price</th><th>Product Quantity</th>
